%_____________________________LIVRO________________________________________
...
loutt = 2.4e-4*(xl)*cvl.*sqrt(aux);    % Vazão de Saída de Líquido
...
[max_lout_err max_h_err max_p_err]
